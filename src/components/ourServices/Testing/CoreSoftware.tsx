...
const CoreSoftware = async ({ lang }: { lang: Locale }) => {
  ...
  const DATA = [
    {
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(24).svg?updatedAt=1706633856768',
      styleLine: "flex-row",
      ...
      icon: () => (<svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" viewBox="0 0 35 30" fill="none">
        <path d="M14.9001 1.51556C16.054 -0.488582 18.946 -0.488583 20.0999 1.51556L33.9109 25.5031C35.0624 27.5031 33.6188 30 31.311 30H3.68899C1.38118 30 -0.0623937 27.5031 1.08912 25.5031L14.9001 1.51556Z" fill="url(#paint0_linear_2_12693)" />
        <defs>
          <linearGradient id="paint0_linear_2_12693" x1="17.5" y1="-3" x2="17.5" y2="30" gradientUnits="userSpaceOnUse">
    ...
    {
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(25).svg?updatedAt=1706633856908',
      ...
      icon: () => (<svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" viewBox="0 0 35 30" fill="none">
        <path d="M14.9001 1.51556C16.054 -0.488582 18.946 -0.488583 20.0999 1.51556L33.9109 25.5031C35.0624 27.5031 33.6188 30 31.311 30H3.68899C1.38118 30 -0.0623937 27.5031 1.08912 25.5031L14.9001 1.51556Z" fill="url(#paint0_linear_2_12762)" />
        <defs>
          <linearGradient id="paint0_linear_2_12762" x1="17.5" y1="-3" x2="17.5" y2="30" gradientUnits="userSpaceOnUse">
    ...
    {
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(26).svg?updatedAt=1706633856884',
      styleLine: "flex-row ",
        ...
        bg-[linear-gradient(180deg,_#11142B_0%,_rgba(17,_20,_43,_0.60)_100%)] px-[24px] md:px-[40px] py-[64px] lg:px-[103px] lg:py-[128px]'>
          ...
          <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" className='flex flex-col items-center gap-[12 px]'>
            <span className='text-gradient text-[40px] leading-[56px] tracking-[-1.5px]'>
              {t("service-page.testing.core.titleHighlight")}</span>
            <span className='text-gradient-3  text-[48px]  leading-[56px ] md:text-[72px] md:leading-[80px] lg:text-[90px] lg:leading-[88px] lg:tracking-[0.45px] font-bold text-center'>
              {t("service-page.testing.core.title")}
            </span>
          </div>
