...
const ServiceTesting = ({ lang }: { lang: Locale }) => {

  const { t } = useTranslation(lang)

  const DATA = [
    {
      number: t("service-page.testing.service.items.item1.number"),
      title: t("service-page.testing.service.items.item1.title"),
      content: t("service-page.testing.service.items.item1.content"),
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(1).png?updatedAt=1706865360476'
    },
    {
      number: t("service-page.testing.service.items.item2.number"),
      title: t("service-page.testing.service.items.item2.title"),
      content: t("service-page.testing.service.items.item2.content"),
      img: "https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(28).svg?updatedAt=1706633856955"
    },
    {
      number: t("service-page.testing.service.items.item3.number"),
      title: t("service-page.testing.service.items.item3.title"),
      content: t("service-page.testing.service.items.item3.content"),
      img: "https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image.png?updatedAt=1706865136219"
    },
    {
      number: t("service-page.testing.service.items.item4.number"),
      title: t("service-page.testing.service.items.item4.title"),
      content: t("service-page.testing.service.items.item4.content"),
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(2).png?updatedAt=1706865360477'
    },
    {
      number: t("service-page.testing.service.items.item5.number"),
      title: t("service-page.testing.service.items.item5.title"),
      content: t("service-page.testing.service.items.item5.content"),
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/image%20(2).png?updatedAt=1706865360477'
    },
  ]
      ...
      <div className="px-6 ">
        <div className="w-full md:max-w-4.5xl lg:max-w-7xl mx-auto flex flex-col gap-[32px] ">
          <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" className='flex flex-col md:flex-row gap-[32px]'>
            <div className='flex flex-col gap-[10px] md:gap-[12px]'>
              <span className='text-gradient-2 w-full text-[32px] leading-[48px] md:text-[36px] tracking-[-0.5px ] md:leading-[48px] md:tracking-[-1.5px] lg:text-[40px] lg:leading-[56px] lg:tracking-[1.5px] capitalize'>
                {t("service-page.testing.service.titleHighlight")}
              </span>
          ...
          <div className='flex gap-[32px] flex-col md:flex-row md:items-center md:justify-between'>
            <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" className='h-full md:max-w-[40vw] lg:w-[38%] lg:max-w-[481px] '>
              {DATA.map(el => (
                <Transition
                  ...
                  key={el.number}
                >
                  <div key={el.number} data-aos="flip-left" className={`${active === el.number ? "" : 'hidden'} rounded-[40px]  bg-[linear-gradient(180deg,_rgba(255,_255,_255,_0.20)_0%,_rgba(255,_255,_255,_0.05)_100%)]`}>
