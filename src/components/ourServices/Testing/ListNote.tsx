...
const ListNoteTesting = async ({ lang }: { lang: Locale }) => {
  const { t } = await useTranslation(lang)

  const DATA = [
    {
      img: "https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/img%20(5).svg?updatedAt=1706633859887",
      styleLine: "rounded-[34px] bg-[linear-gradient(253deg,_#FBF775_13.62%,_#72F7BE_90.04%)]",
      sub: t("service-page.testing.list-note.items.item1.sub")
    },
    {
      img: "https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/img%20(6).svg?updatedAt=1706633856847",
      styleLine: "rounded-[34px] bg-[linear-gradient(254deg,_#01CDCB_12.62%,_#00A6F9_81.94%)] [box-shadow:0px_0px_24px_0px_#00A6F9]",
      sub: t("service-page.testing.list-note.items.item2.sub")
    },
    {
      img: "https://ik.imagekit.io/arsdfirst/spatium/our-sevices/testing/New%20Folder/img%20(7).svg?updatedAt=1706633856599",
      styleLine: "rounded-[34px] bg-[linear-gradient(253deg,_#DE8EC6_13.62%,_#CC4FF7_90.04%)]",
      sub: t("service-page.testing.list-note.items.item3.sub")
    },
  ]
    ...
    <section className="relative  pt-[135px]  px-[24px] md:px-0 pb-[64px] md:pb-[128px]">
      <div className="flex justify-center gap-[32px] relative">
        ...
        <div className=" relative w-full md:max-w-4.5xl lg:max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-[32px] ">
          {
            DATA.map(el => (
              <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" className='col-span-1 flex flex-col px-[28px] py-[24px] gap-[24px] rounded-[16px] border-[0px] border-[solid] border-[#FBF775] bg-[linear-gradient(180deg,_rgba(255,_255,_255,_0.20)_0%,_rgba(255,_255,_255,_0.05)_100%)]'>
...
export default ListNoteTesting 