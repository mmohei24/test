...
const ListNoteMobileAppDevelopment = async ({ lang }: { lang: Locale }) => {
  const { t } = await useTranslation(lang)

  const DATA = [
    {
      img: "https://ik.imagekit.io/arsdfirst/spatium/our-sevices/mobile-app/New%20Folder/img%20(3).svg?updatedAt=1706631454616",
      styleLine: "rounded-[34px] bg-[linear-gradient(254deg,_#01CDCB_12.62%,_#00A6F9_81.94%)] [box-shadow:0px_0px_24px_0px_#00A6F9]",
      sub: t("service-page.mobile-development.list-note.items.item1.sub")
    },
    {
      img: 'https://ik.imagekit.io/arsdfirst/spatium/our-sevices/mobile-app/New%20Folder/img%20(4).svg?updatedAt=1706631454358',
      styleLine: "rounded-[34px] bg-[linear-gradient(253deg,_#DE8EC6_13.62%,_#CC4FF7_90.04%)]",
      sub: t("service-page.mobile-development.list-note.items.item2.sub")
    },
  ]
  return (
...
export default ListNoteMobileAppDevelopment 